...
async function clear(databaseInfo: DatabaseInfo) {
...
async function count(databaseInfo: DatabaseInfo) {
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return 0;
    }
...
async function deleteValue(databaseInfo: DatabaseInfo, key: IDBValidKey) {
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return false;
    }
...
async function getAll(databaseInfo: DatabaseInfo) {
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return [];
    }
...
async function getAllStrings(databaseInfo: DatabaseInfo) {
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return [];
    }
...
async function getBatch(databaseInfo: DatabaseInfo, reset: boolean): Promise<any[]> {
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return [];
    }
...
async function getBatchStrings(databaseInfo: DatabaseInfo, reset: boolean) {
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return [];
    }
...
async function getValue(databaseInfo: DatabaseInfo, key: IDBValidKey) {
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return null;
    }
...
async function getValueString(databaseInfo: DatabaseInfo, key: IDBValidKey) {
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return null;
    }
...
async function putValue(databaseInfo: DatabaseInfo, value: string) {
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return false;
    }
...
async function putValues(databaseInfo: DatabaseInfo, values: string[]) {
    debugger;
    const db = await openDatabase(databaseInfo);
    if (!db) {
        return false;
